        ...
        <div className="flex-1">
          <ul className="pt-2 pb-4 space-y-1 text-sm">
            <li className="rounded-sm">
              <Link to={`/calendar`} className="btn btn-ghost normal-case text-lg">
                <svg
      ...
      {user ? (
        <div>
          <div>
            <ul className="mb-4">
              <li className="rounded-sm">
                <Link to={`/profile/${username}`} className="btn btn-ghost normal-case text-lg">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
              ...
              <li className="rounded-sm">
                <Link to={`/profile/${username}/settings`} className="btn btn-ghost normal-case text-lg">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
          ...
          <div className="avatar mb-4" style={{ marginLeft: "19px" }}>
