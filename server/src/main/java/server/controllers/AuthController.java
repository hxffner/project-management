...
public class AuthController {
    ...
    public ResponseEntity<?> login(@Valid @RequestBody LoginRequest loginRequest) {
        ...
        return ResponseEntity.ok(new JwtResponse(jwt, userDetails.getUsername(), userDetails.getUser().getEmail(), userDetails.getUser().getAvatarPath(), userDetails.getUser().getCreatedAt()));
    }
